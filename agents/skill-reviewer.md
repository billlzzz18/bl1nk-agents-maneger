---
name: skill-reviewer
description: Use this agent when the user has created or modified a skill and needs
  quality review, or wants to ensure skill follows best practices. Trigger proactively
...
>
> *Note: Skill created, proactively trigger skill-reviewer to ensure it follows best practices.*

---

> **Example 2: Skill Review Request**
>
...
>
> *Note: Explicit skill review request triggers the agent.*

---

> **Example 3: Skill Description Modified**
>
...
>
> *Note: Skill description modified, review for triggering effectiveness.*
