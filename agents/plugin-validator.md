...
description: Use this agent when the user asks to validate a plugin, check plugin
  structure, or mentions plugin validation. Trigger proactively after user creates
  or modifies plugin components.
category: utility
model: inherit
color: yellow
tools:
